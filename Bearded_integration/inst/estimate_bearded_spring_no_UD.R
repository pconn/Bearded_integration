...
TmbFile1 = "C:/Users/paul.conn/git/Bearded_integration/Bearded_integration/src/fit_bearded_real_noUD"
...
high = 5; 
log_2012_SE[log_2012_SE>high]=100000
log_2013_SE[log_2013_SE>high]=100000
log_2016_SE[log_2016_SE>high]=100000
...
Data<- list("Acc_k"=as.matrix(Acc_det_sum[,c(2,4,6,8,10)]), 
            ...
            "log_2012_N" = log_2012_N, "log_2013_N"=log_2013_N,"log_2016_N"=log_2016_N,
            "log_2012_se" = log_2012_SE,"log_2013_se" = log_2013_SE,"log_2016_se" = log_2016_SE,
            "N_2012" = exp(log_2012_N), "N_2013"=exp(log_2013_N), "N_2016"=exp(log_2016_N),
...
Obj = MakeADFun( data=Data, parameters=Params, random=Random, map=Map, DLL="fit_bearded_real_noUD",silent=FALSE)
Obj$fn( Obj$par )
