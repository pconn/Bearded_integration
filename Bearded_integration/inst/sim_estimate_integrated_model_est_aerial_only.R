...
TmbFile1 = "C:/Users/paul.conn/git/Bearded_integration/Bearded_integration/src/fit_bearded_sim_aerial_only"
...
Obj = MakeADFun( data=Data, parameters=Params, random=Random, map=Map, DLL="fit_bearded_sim_aerial_only",silent=FALSE)
Obj$fn( Obj$par )
