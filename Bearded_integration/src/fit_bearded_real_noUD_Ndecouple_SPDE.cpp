...
Type objective_function<Type>::operator() ()
{
  ...
  // global stuff
  vector<Type> jnll_comp(7);  //neg. log likelihood components: UD, CKMR, Aerial, Acoustics, spline prior
  jnll_comp.setZero();
  Type jnll = 0.0;
  Type N = exp(log_N);
  ...
  Exp_log_N_2012 = log(Exp_log_N_2012);
  Exp_log_N_2013 = log(Exp_log_N_2013);
  ...
  Exp_log_N_2016 = log(Exp_log_N_2016);
